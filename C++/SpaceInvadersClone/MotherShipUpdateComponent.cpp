...
void MotherShipUpdateComponent::reverse()
{
	//m_MovingRight = !m_MovingRight;
	//m_TC->getLocation().x -= m_TC->getSize().x;
...
bool MotherShipUpdateComponent::isMovingRight()
{
	return m_MovingRight;
}

/*
void MotherShipUpdateComponent::initializeBulletSpawner(
