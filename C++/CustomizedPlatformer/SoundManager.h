...
private:
	...
	SoundBuffer m_FallInSandBuffer;
	SoundBuffer m_FallInCrazyBuffer;
	...
	Sound m_FallInSandSound;
	Sound m_FallInCrazySound;
	Sound m_JumpSound;
...
public:
	...
	void playFallInCrazySpace();
	void playFallInQuickSand();
	void playJump();
	void playReachGoal();
};
