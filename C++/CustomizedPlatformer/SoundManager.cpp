...
SoundManager::SoundManager()
{
	...
	m_FallInCrazyBuffer.loadFromFile("sound/crazyspace.wav");
	m_FallInSandBuffer.loadFromFile("sound/fallinsand.wav");
	...
	m_FallInSandSound.setBuffer(m_FallInSandBuffer);
	m_FallInCrazySound.setBuffer(m_FallInCrazyBuffer);
...
void SoundManager::playFallInCrazySpace()
{
	m_FallInCrazySound.setRelativeToListener(true);
	m_FallInCrazySound.play();

}

void SoundManager::playFallInQuickSand()
{
	m_FallInSandSound.setRelativeToListener(true);
	m_FallInSandSound.play();
}
